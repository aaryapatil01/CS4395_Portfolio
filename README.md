...
This is our second assignment. We nad to analyze text from a file and then create a word guessing game using the top 50 most common nouns from the file.
